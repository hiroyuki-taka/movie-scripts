...
class TsInformation:
    ...
    def formatString(self, string: Union[str, AribString]) -> str:
        ...
        result = str(string)
        result = result.translate(self.__getFormatStringTranslationTable())

        # 置換した文字列を返す
        return result

    @lru_cache(maxsize=1)
    def __getFormatStringTranslationTable(self) -> dict:
        """
        ...
        return str.maketrans(merged_table)
